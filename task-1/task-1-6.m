...
(**)
(*(* Triple Gauge Vertex *)*)
(*TGV[\[Mu]_,\[Nu]_,\[Lambda]_,p3_,p4_,q1_]:=MetricTensor[\[Mu],\[Nu]] . FV[p3-p4,\[Lambda]]+MetricTensor[\[Lambda],\[Nu]] . FV[-q1-p3,\[Mu]]+MetricTensor[\[Lambda],\[Mu]] . FV[q1+p4,\[Nu]]*)
(**)
...
(*SP[p4,p4]=mW^2;*)
(**)
(*SpinorVBar[p2,0] . GA[\[Lambda]] . SpinorU[p1,0] . TGV[\[Mu],\[Nu],\[Lambda],p3,p4,q1] . Pair[LorentzIndex[\[Mu]],Momentum[Polarization[p4,-I]]] . Pair[LorentzIndex[\[Nu]],Momentum[Polarization[p3,-I]]];*)
(*% ComplexConjugate[%];*)
...
(**)
(*(* MZ^2 *)*)
(*SpinorVBar[p2,0] . ZF[\[Lambda]] . SpinorU[p1,0] . TGV[\[Mu],\[Nu],\[Lambda],p3,p4,q1] . Pair[LorentzIndex[\[Mu]],Momentum[Polarization[p4,-I]]] . Pair[LorentzIndex[\[Nu]],Momentum[Polarization[p3,-I]]];*)
(*% ComplexConjugate[%];*)
(*DoPolarizationSums[%,p3];*)
(*DoPolarizationSums[%,p4];*)
(*FermionSpinSum[%,ExtraFactor->1/4];*)
...
(**)
(*(* M\[Nu]^2 *)*)
(*SpinorVBar[p2,0] . GA[\[Mu]] . GS[q2] . GA[\[Nu]] . (1-GA5) . SpinorU[p1,0] . Pair[LorentzIndex[\[Mu]],Momentum[Polarization[p4,-I]]] . Pair[LorentzIndex[\[Nu]],Momentum[Polarization[p3,-I]]];*)
(*% ComplexConjugate[%];*)
(*FermionSpinSum[%,ExtraFactor->1/4];*)
(*DoPolarizationSums[%,p3];*)
(*DoPolarizationSums[%,p4];*)
...
(*ComplexConjugate[SpinorVBar[p2,0] . GA[\[Lambda]] . SpinorU[p1,0] . TGV[\[Mu],\[Nu],\[Lambda],p3,p4,q1] . Pair[LorentzIndex[\[Mu]],Momentum[Polarization[p4,-I]]] . Pair[LorentzIndex[\[Nu]],Momentum[Polarization[p3,-I]]]] . SpinorVBar[p2,0] . ZF[\[Sigma]] . SpinorU[p1,0] . TGV[\[Alpha],\[Beta],\[Sigma],p3,p4,q1] . Pair[LorentzIndex[\[Alpha]],Momentum[Polarization[p4,-I]]] . Pair[LorentzIndex[\[Beta]],Momentum[Polarization[p3,-I]]];*)
(*DoPolarizationSums[%,p3];*)
(*DoPolarizationSums[%,p4];*)
(*FermionSpinSum[%,ExtraFactor->1/4];*)
(**)
...
(*ComplexConjugate[SpinorVBar[p2,0] . ZF[\[Lambda]] . SpinorU[p1,0] . TGV[\[Mu],\[Nu],\[Lambda],p3,p4,q1] . Pair[LorentzIndex[\[Mu]],Momentum[Polarization[p4,-I]]] . Pair[LorentzIndex[\[Nu]],Momentum[Polarization[p3,-I]]]] . SpinorVBar[p2,0] . GA[\[Alpha]] . GS[q2] . GA[\[Beta]] . (1-GA5) . SpinorU[p1,0] . Pair[LorentzIndex[\[Alpha]],Momentum[Polarization[p4,-I]]] . Pair[LorentzIndex[\[Beta]],Momentum[Polarization[p3,-I]]];*)
(*DoPolarizationSums[%,p3];*)
(*DoPolarizationSums[%,p4];*)
(*FermionSpinSum[%,ExtraFactor->1/4];*)
(**)
...
(*Pair[Momentum[p1-p3],Momentum[p1-p3]]=mW^2-2*Ecm/2*(Ecm/2-p*Cos[\[Theta]]);*)
...
(**)
(*Plot[{xsec1,xsec2,xsec3,xsec4},{Ecm,160,210},Frame->True,PlotLegends->{"\!\(\*SubscriptBox[\(g\), \(WWZ\)]\) = -0.7","\!\(\*SubscriptBox[\(g\), \(WWZ\)]\) = -0.9","\!\(\*SubscriptBox[\(g\), \(WWZ\)]\) = 0.9","\!\(\*SubscriptBox[\(g\), \(WWZ\)]\) = 0.7"},PlotRange->{0,30}];*)
(*Labeled[%,{"\[Sigma] (pb)","\!\(\*SubscriptBox[\(E\), \(cm\)]\) (GeV)"},{Left,Bottom}]*)
(**)
